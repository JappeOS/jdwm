...
mixin _$WindowMoveState {
  ...
  $WindowMoveStateCopyWith<WindowMoveState> get copyWith =>
      _$WindowMoveStateCopyWithImpl<WindowMoveState>(
          this as WindowMoveState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WindowMoveState &&
...
abstract mixin class $WindowMoveStateCopyWith<$Res> {
  factory $WindowMoveStateCopyWith(
          WindowMoveState value, $Res Function(WindowMoveState) _then) =
      _$WindowMoveStateCopyWithImpl;
  @useResult
  $Res call(
...
extension WindowMoveStatePatterns on WindowMoveState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_WindowMoveState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool moving, Offset startPosition, Offset movedPosition,
            Offset delta)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _WindowMoveState() when $default != null:
        return $default(_that.moving, _that.startPosition, _that.movedPosition,
            _that.delta);
      case _:
        return orElse();
    }
...
class _WindowMoveState implements WindowMoveState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WindowMoveStateCopyWith<_WindowMoveState> get copyWith =>
      __$WindowMoveStateCopyWithImpl<_WindowMoveState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _WindowMoveState &&
            (identical(other.moving, moving) || other.moving == moving) &&
            (identical(other.startPosition, startPosition) ||
                other.startPosition == startPosition) &&
            (identical(other.movedPosition, movedPosition) ||
...
/// @nodoc
abstract mixin class _$WindowMoveStateCopyWith<$Res>
    implements $WindowMoveStateCopyWith<$Res> {
  factory _$WindowMoveStateCopyWith(
          _WindowMoveState value, $Res Function(_WindowMoveState) _then) =
      __$WindowMoveStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool moving, Offset startPosition, Offset movedPosition, Offset delta});
