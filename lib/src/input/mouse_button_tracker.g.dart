...
final mouseButtonTrackerProvider = MouseButtonTrackerProvider._();

final class MouseButtonTrackerProvider extends $FunctionalProvider<
    MouseButtonTracker,
    MouseButtonTracker,
    MouseButtonTracker> with $Provider<MouseButtonTracker> {
  MouseButtonTrackerProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
